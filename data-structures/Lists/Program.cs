...
namespace Lists
{
    class Program
    {
        ...
        {
            // like arrays, each List instance can contain just one particular type of data, when you choose when you create the list
            ...
            numbers.Remove(500); // removes only the first instance of 500. Returns false if it doesn't find the item
            ...
            // you can use foreach with any collection (anything that implements the interfaces IEnumberable or IEnumerable<T>)
        }
    }
}
