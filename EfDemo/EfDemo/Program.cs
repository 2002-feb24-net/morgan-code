...
namespace EfDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Please enter an ID for a new person");
            int newID = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("Please enter a NAME for a new person");
            var newName = Console.ReadLine();
            AddPerson(newID, newName);

            // prompt for the name of a person to delete. (call your method)
            Console.WriteLine("Type the name of the person you want to delete");
        ...
        public static void DeletePersonByName(string name)
        {
            ...
            var toBeDeleted = context.Persons.First(p => p.Name == name);
        ...
        public static void Setup()
        {
            ...
            using (var context = new PersonContext())
            {
                ...
                // instead of using EnsureCreated, the proper way to update the database's structure based on my C# code is migrations
